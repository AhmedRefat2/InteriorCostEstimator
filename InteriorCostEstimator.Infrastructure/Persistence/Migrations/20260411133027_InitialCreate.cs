        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatsAppLink = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetectedObjects_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DetectedObjectId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchedProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchedProducts_DetectedObjects_DetectedObjectId",
                        column: x => x.DetectedObjectId,
                        principalTable: "DetectedObjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchedProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MatchedProducts_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetectedObjects_ProjectId",
                table: "DetectedObjects",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchedProducts_DetectedObjectId",
                table: "MatchedProducts",
                column: "DetectedObjectId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchedProducts_ProductId",
                table: "MatchedProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchedProducts_ProjectId",
                table: "MatchedProducts",
                column: "ProjectId");
